...
$CD18 (PUTCHR) Put Character
    ...
    A-register.   If the "Special I/O Flag" (see Memory Map) is zero,
    ...
    contents of this location is used as a address of a File Control
...
$C6FF. The system FCB at location $C840 may also be used in user
