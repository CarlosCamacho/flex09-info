...
> Source: `apps/dataman/DMANMAN2 - DataMan Database - Documentation and Examples.zip!DMANMAN2.DSK!DMAN-21.TXT`  
...
.FI
.SP3
This program lists the disk files for the user without leaving the DATAMAN system.
.sp2
.nf
.lm 10
21.1.0
...
The program lists the '.SPC' and '.DAT' files of DATAMAN databases.
