...
> Source: `apps/dataman/DMANMAN2 - DataMan Database - Documentation and Examples.zip!DMANMAN2.DSK!DMAN-19.TXT`  
...
.LM 55
.FI
This program will build a data file which is compatible with the TSC 'TEXT PROCESSOR'.
...
not possible with the report writers of DATAMAN.
...
The 'NAME', 'PASSWORD', and 'DRIVE' the database is on are entered.
...
or he can 'CONTINUE'.
.sp
The 'NAME' of the 'PR' data file and the 'DRIVE' it is to be put on, is now entered.
...
.sp
The standard 'EOF' character ('>') and 'EOR' character ('>>') is used for complete compatibility with the
'PR' processor.
.sp2
.lm10
.nf
