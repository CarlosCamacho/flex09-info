...
> Source: `utilities/dru-series/DRU_14 - DRU Utility Collection - Programs, Source, and Build Files - Includes CALENDAR, DIET, DIETER-F.zip!DRU_14.DSK!READ-ME.TXT`  
> Method: FLEX disk extraction

OCR and media-decoding errors may remain.

'DIET-TRAC'Diet Forecaster'Flex9 Version 1.0'
...
All of this material is, as well as the attached programs,
...
will act as described, nor that it will be useful for
...
'DIET-TRAC	1.0'Diet Forecaster'SECTION I'
...
'DIET-TRAC	1.0'Diet Forecaster'SECTION II'
SECTION II - INSTALLATION

You are provided with two 5" disks if you requested 5" on your order.
On one disk you will find the READ-ME.TXT which gives the instruction
and explanation for using DIET-TRAC, along with two trial DATA (.DAT)
files. On the other disk you will find the compiled DIET-TRAC programs
and a PRINT.SYS file and a COPY.CMD.
Make a copy of both disks.
Only a single 8" disk is supplied with all the files on it if you
ordered an 8" copy. Make a copy of this disk also.
There should be enough room on your 5" disk or 8" disk to add any
other system programs you feel necessary (i.e. FLEX.SYS, PRINT.CMD,
XBASIC.CMD, DIR.CMD etc.).
...
length of your own print driver routine. Be sure to rename your print
...
from the 2nd program disk in Drive # 0 to your blank disk in Drive # 1.

Load in XBASIC. Remove your FLEX operating disk, and
install the DIET-TRAC program disk in Drive # 0, or put XBASIC and
other needed files on this disk, and then call up XBASIC.
Insert a blank disk to be used for datafiles in Drive # 1.

The 5" disks supplied are 40-track, single-sided, single-density
...
*Note that the last three files are on a second 5" disk if you ordered
an a 5" disk, while all files are on the single 8" disk order.

Source Listing on Disk is Available for $99.95 from South East Media,
and a Printed Manual is Available for $19.95.

The COPY file is for your own convenience in transferring these
programs to additional disks if your library of datafiles grows
...
supplied.
The 'PRINT.SYS' routine you use must be on Drive # 0, as the
...
'write-protect' the data disk you use
(in Drive # 1),
...
'DIET-TRAC	1.0'Diet Forecaster'SECTION III'
...
'DIET-TRAC	1.0'Diet Forecaster'SECTION IV'
...
'DIET-TRAC	1.0'Diet Forecaster'SECTION V'
...
'DIET-TRAC	1.0'Diet Forecaster'APPENDIX A'
...
'DIET-TRAC	1.0'Diet Forecaster'APPENDIX B'
HAPPY HEALTH TO YOU.
...
'DIET-TRAC	1.0'Diet Forecaster'APPENDIX C'
...
'DIET-TRAC	1.0'Diet Forecaster'APPENDIX D'
...
'DIET-TRAC	1.0'Diet Forecaster'APPENDIX E'
