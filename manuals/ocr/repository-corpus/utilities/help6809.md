...
> Source: `utilities/system/HELP09 - FLEX System Utilities - Program Disk.zip!HELP09.DSK!HELP6809.TXT`  
...
HELP4	LEAX LINBUF,PCR point to line buffer
	...
	LBNE HELP1 no, get another line
...
ILLCMD	LEAY ILCMST,PCR "illegal Command"
...
CPRMEM	DEC <SRHLIM
	BEQ NOTHR
CPR1	LDA 0,X+ get buffer character
...
CLRPRT	CLR <PFLG found, clear print flag
	...
	STA 0,X+ add two dummy bytes
	STA 0,X+ to work with both
	LDA #$FF command & target search
	STA 0,X "FF" marks end of table
...
YSNSTR	FCC /Like more HELP ( Y or N )? /,$D
WESRST	FCC /We were looking for /,$D

TARGET	RMB 32
LINBUF	RMB 90 Could be longer
