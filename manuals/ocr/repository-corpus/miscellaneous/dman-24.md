...
> Source: `misc/uncategorized/FULL - FLEX Software Archive - Program and Support Utilities - Includes DMAN-09, MACRO, DMAN-18.zip!FULL.DSK!DMAN-24.TXT`  
...
Basically, the program looks at all 'TYPE 2' and 'TYPE 3' data fields and checks for any alpha characters except for '+', '-', and '.'
signs.
...
First, the length of the data is found and if it is over 15 characters in length, it goes to the separate character
check.
...
Because '0' as the data would return a '0' for the conversion, a second check is made to make sure that when the string
is converted, it is the length of a non-converted string plus 2 (the leading and trailing space of a numeric variable in
BASIC).
Data of '123FG4' would be returned as '123' after conversion by the 'VAL' function and would be found by this line as
having a problem.
.sp
If the data does not pass this test, or if the data string is over 15 characters (the precision of BASIC), then
