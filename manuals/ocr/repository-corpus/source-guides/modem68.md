...
> Source: `sourcecode/library-disks/LIB26 - FLEX Source Library - Source Code and Build Files - Includes COLORLIB, CWRITER, CWRTINI.zip!LIB26.DSK!MODEM68.DOC`  
...
The	Christensen	protocol	has	been	well	documented,	and	an
excellent	description	can	be found in the May	and	June	1983
issues of YOUR COMPUTER.	The only difference for a header	block
...
When opening files for send or recieve care should be taken as to
what mode you require for this operation. Consult the FLEX manual
for guidence in this mater. Squeezed files should be taken	as	a
binary file. Watch in the way	FLEX	handles space compression in
text files, and also the control characters LF, TAB etc.
...
changed. Note that the 6850 baud rate clock should be set to 1200
as the implemented baud rate switch sets a divide by 64 or 16.
...
(such as CRC checking) are encouraged.
	...
	Leopold
	Victoria 3221
	052-50-2334 weekends and evenings
