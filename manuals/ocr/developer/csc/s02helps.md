...
> Source: `dev/csc/CSCPRODS_4 - CSC Development - Programs, Source, and Build Files.zip!CSCPRODS_4.DSK!S02HELPS.TXT`  
...
TORE IT
 ...
 LBSR PUTCHR ECHO IT
 LSR SECURE,PCR DISABLE SECURE FLAG
FUNS5G INC [CUROFF,PCR] INCR OFFSET
 LDA AUTSKP,PCR CHECK AUTOSKIP
 CMPA #$41 A
 BNE FUNS5E
 LDA [CUROFF,PCR] CHECK CURSOR OFL SECURE,PCR ENABLE SECURE FLAG
 LEAX [SPOINT,PCR] STRING OUTPUT
 LBSR PUTSTR SEND IT
 NEGB COUNT CHARS
 ADDB $03,X
 ADDB COLCOL,PCR
 STB COLCOL,PCR SAVE LAST COL
 LEAX CONT40,PCR RESET ATTRIBUTE
 LBSR SETATT
 BRA STEROR EXIT
*
FUNS03 EQU * CLEAR SCREEG]QN4uRSTWyX|Wp\~oc`)Jd5fli2Tm>omruu0`yy4iSq|sLz
s
|Y66
=
ED2##(G(+KmM
